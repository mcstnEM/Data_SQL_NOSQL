...
--
-- Hôte : db.3wa.io
-- Généré le : mer. 27 oct. 2021 à 14:42
...
--
-- Base de données : `jeanluclacaze_classicModels`
--
...
(10432, 'S18_2795', 5, 168.75, 2),
(10432, 'S18_3320', 1, 99.21, 1),
(10433, 'S24_2011', 3, 122.89, 1),
(10434, 'S18_4522', 1, 87.77, 5),
(10434, 'S24_2011', 3, 122.89, 3),
(10434, 'S24_3371', 1, 61.23, 4),
(10434, 'S24_4278', 112, 72.45, 1),
(10434, 'S32_2206', 2, 40.23, 2);
...
(10432, '2021-06-23', '2021-06-23', NULL, 'In Process', NULL, 103),
(10433, '2021-06-29', '2021-06-29', NULL, 'In Process', NULL, 103),
(10434, '2021-08-02', NULL, NULL, 'In Process', NULL, 103);
...
ALTER TABLE `orderdetails`
  ...
  ADD CONSTRAINT `orderdetails_ibfk_2` FOREIGN KEY (`productCode`) REFERENCES `products` (`productCode`) ON DELETE CASCADE ON UPDATE CASCADE;
